...
adr = adr.drop(['SHRCLS', 'TSYMBOL'], axis = 1)
adr = adr.dropna()


adr_cmpstat = adr_cmpstat.drop(['gvkey','iid','datadate','tic'], axis=1)
adr_cmpstat = adr_cmpstat.dropna()


newADR = adr.merge(adr_cmpstat, how='inner', on='CUSIP')
